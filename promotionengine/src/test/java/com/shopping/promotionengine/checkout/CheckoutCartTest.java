...
public class CheckoutCartTest extends TestCase {
	...
	public void testScenarioA() {
		assertEquals(100.0, checkoutCart.priceCart(Arrays.asList("A","B","C"), allProducts, unitBasedPromotions, comboBasedPromotions));
	}
	
	public void testScenarioB() {
		assertEquals(370.0, checkoutCart.priceCart(Arrays.asList("A","A","A","A","A","B","B","B","B","B","C"), allProducts, unitBasedPromotions, comboBasedPromotions));
	}
